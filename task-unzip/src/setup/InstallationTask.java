 ...
 * <ul>
 *   <li>{@link setup.InstallationTask#getLocation <em>Location</em>}</li>
 *   <li>{@link setup.InstallationTask#getRelativeProductFolder <em>Relative Product Folder</em>}</li>
 * </ul>
 * </p>
 *
 * @see setup.SetupPackage#getInstallationTask()
 * @model
 * @generated
 */
public interface InstallationTask extends SetupTask
{
   ...
   * @see setup.SetupPackage#getInstallationTask_Location()
  ...
  /**
   * Sets the value of the '{@link setup.InstallationTask#getLocation <em>Location</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see setup.SetupPackage#getInstallationTask_RelativeProductFolder()
   * @model default="" required="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link setup.InstallationTask#getRelativeProductFolder <em>Relative Product Folder</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
