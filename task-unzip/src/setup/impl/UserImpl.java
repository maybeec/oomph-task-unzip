 ...
 * <ul>
 *   <li>{@link setup.impl.UserImpl#getAttributeRules <em>Attribute Rules</em>}</li>
 *   <li>{@link setup.impl.UserImpl#getAcceptedLicenses <em>Accepted Licenses</em>}</li>
 *   <li>{@link setup.impl.UserImpl#getUnsignedPolicy <em>Unsigned Policy</em>}</li>
 *   <li>{@link setup.impl.UserImpl#getQuestionnaireDate <em>Questionnaire Date</em>}</li>
 *   <li>{@link setup.impl.UserImpl#isPreferenceRecorderDefault <em>Preference Recorder Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserImpl extends ScopeImpl implements User
{
  ...
  public EList<AttributeRule> getAttributeRules()
  {
    ...
    {
      attributeRules = new EObjectContainmentEList<AttributeRule>(AttributeRule.class, this, SetupPackage.USER__ATTRIBUTE_RULES);
    }
