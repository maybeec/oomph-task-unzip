...
import setup.util.SetupValidator;
...
public class SetupPackageImpl extends EPackageImpl implements SetupPackage
{
   ...
   * @see setup.SetupPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static SetupPackage init()
  {
    ...
    BasePackageImpl theBasePackage = (BasePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(BasePackage.eNS_URI) instanceof BasePackageImpl ? EPackage.Registry.INSTANCE
