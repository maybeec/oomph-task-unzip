 ...
 * <ul>
 *   <li>{@link setup.Project#getStreams <em>Streams</em>}</li>
 *   <li>{@link setup.Project#getProjectContainer <em>Project Container</em>}</li>
 *   <li>{@link setup.Project#getLogicalProjectContainer <em>Logical Project Container</em>}</li>
 *   <li>{@link setup.Project#getParentProject <em>Parent Project</em>}</li>
 *   <li>{@link setup.Project#getProjectCatalog <em>Project Catalog</em>}</li>
 * </ul>
 * </p>
 *
 * @see setup.SetupPackage#getProject()
 * @model
 * @generated
 */
public interface Project extends ProjectContainer
{
   ...
   * It is bidirectional and its opposite is '{@link setup.Stream#getProject <em>Project</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see setup.SetupPackage#getProject_Streams()
   * @see setup.Stream#getProject
   * @model opposite="project" containment="true" keys="name"
   ...
   * It is bidirectional and its opposite is '{@link setup.ProjectContainer#getProjects <em>Projects</em>}'.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see setup.SetupPackage#getProject_ProjectContainer()
  ...
  /**
   * Sets the value of the '{@link setup.Project#getProjectContainer <em>Project Container</em>}' container reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see setup.SetupPackage#getProject_LogicalProjectContainer()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link setup.Project#getLogicalProjectContainer <em>Logical Project Container</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see setup.SetupPackage#getProject_ParentProject()
   ...
   * @see setup.SetupPackage#getProject_ProjectCatalog()
   * @model resolveProxies="false" transient="true" changeable="false" volatile="true" derived="true"
   * @generated
   */
