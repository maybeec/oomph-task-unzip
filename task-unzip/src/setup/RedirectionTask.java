 ...
 * <ul>
 *   <li>{@link setup.RedirectionTask#getSourceURL <em>Source URL</em>}</li>
 *   <li>{@link setup.RedirectionTask#getTargetURL <em>Target URL</em>}</li>
 * </ul>
 * </p>
 *
 * @see setup.SetupPackage#getRedirectionTask()
 * @model
 * @generated
 */
public interface RedirectionTask extends SetupTask
{
   ...
   * @see setup.SetupPackage#getRedirectionTask_SourceURL()
   * @model required="true"
   * @generated
   */
  String getSourceURL();
  ...
  /**
   * Sets the value of the '{@link setup.RedirectionTask#getSourceURL <em>Source URL</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see setup.SetupPackage#getRedirectionTask_TargetURL()
   * @model required="true"
   * @generated
   */
  String getTargetURL();
  ...
  /**
   * Sets the value of the '{@link setup.RedirectionTask#getTargetURL <em>Target URL</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
