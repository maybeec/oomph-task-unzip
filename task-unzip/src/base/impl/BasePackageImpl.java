...
import base.util.BaseValidator;
import setup.SetupPackage;
import setup.impl.SetupPackageImpl;
import unzip.unzipPackage;
import unzip.impl.unzipPackageImpl;
...
public class BasePackageImpl extends EPackageImpl implements BasePackage
{
  ...
  public static BasePackage init()
  {
    ...
    unzipPackageImpl theunzipPackage = (unzipPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(unzipPackage.eNS_URI) instanceof unzipPackageImpl ? EPackage.Registry.INSTANCE
        .getEPackage(unzipPackage.eNS_URI) : unzipPackage.eINSTANCE);
    SetupPackageImpl theSetupPackage = (SetupPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(SetupPackage.eNS_URI) instanceof SetupPackageImpl ? EPackage.Registry.INSTANCE
        .getEPackage(SetupPackage.eNS_URI) : SetupPackage.eINSTANCE);
  ...
  public void initializePackageContents()
  {
    ...
    EOperation op = addEOperation(modelElementEClass, getAnnotation(), "getAnnotation", 0, 1, IS_UNIQUE, IS_ORDERED);
