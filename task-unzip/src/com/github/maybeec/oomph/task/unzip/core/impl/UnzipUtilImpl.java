...
public class UnzipUtilImpl extends UnzipUtil {
        ...
        try {
            ...
            case UNKNOWN:
                SetupTaskLogger.getLogger()
                    .logWarning("Unknown archive extension of " + file.getName() + ". Trying nevertheless");
                //$FALL-THROUGH$
            case COMPRESSED:
    ...
    private ArchiveType archiveType(String fileName) {
        ...
        if (ending.equals("zip") || ending.equals("cpio") || ending.equals("ar") || ending.equals("tar")
            || ending.equals("jar") || ending.equals("dump") || ending.equals("7z") || ending.equals("arj")) {
            return ArchiveType.ARCHIVE;
        }
        if (ending.equals("bz2") || ending.equals("lzma") || ending.equals("xz") || ending.equals("pack200")
            || ending.equals("z") || ending.equals("gz")) {
