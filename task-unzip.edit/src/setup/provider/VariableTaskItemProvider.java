...
/**
 * This is the item provider adapter for a {@link setup.VariableTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableTaskItemProvider extends SetupTaskItemProvider
{
  ...
  {
    String label = ((VariableTask)object).getName();
    return label == null || label.length() == 0 ? getString("_UI_VariableTask_type") : getString("_UI_VariableTask_type") + " " + label;
  }
