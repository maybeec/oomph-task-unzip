...
/**
 * This is the item provider adapter for a {@link setup.ProductVersion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductVersionItemProvider extends ScopeItemProvider
{
  ...
  {
    String label = ((ProductVersion)object).getName();
    return label == null || label.length() == 0 ? getString("_UI_ProductVersion_type") : getString("_UI_ProductVersion_type") + " " + label;
  }
