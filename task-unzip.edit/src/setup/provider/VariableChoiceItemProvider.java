...
/**
 * This is the item provider adapter for a {@link setup.VariableChoice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableChoiceItemProvider extends ModelElementItemProvider
{
  ...
  {
    String label = ((VariableChoice)object).getValue();
    return label == null || label.length() == 0 ? getString("_UI_VariableChoice_type") : getString("_UI_VariableChoice_type") + " " + label;
  }
