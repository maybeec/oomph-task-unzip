...
/**
 * This is the item provider adapter for a {@link setup.Installation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstallationItemProvider extends ScopeItemProvider
{
  ...
  {
    String label = ((Installation)object).getName();
    return label == null || label.length() == 0 ? getString("_UI_Installation_type") : getString("_UI_Installation_type") + " " + label;
  }
