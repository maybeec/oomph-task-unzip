...
/**
 * This is the item provider adapter for a {@link setup.ResourceCopyTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceCopyTaskItemProvider extends SetupTaskItemProvider
{
  ...
  {
    String label = ((ResourceCopyTask)object).getID();
    return label == null || label.length() == 0 ? getString("_UI_ResourceCopyTask_type") : getString("_UI_ResourceCopyTask_type") + " " + label;
  }
